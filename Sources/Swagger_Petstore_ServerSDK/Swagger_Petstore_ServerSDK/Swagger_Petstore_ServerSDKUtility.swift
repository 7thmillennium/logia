...
*/
public class Swagger_Petstore_ServerSDKUtility {
    ...
    internal static var basePath = "http://petstore.swagger.io/v2"

    // For switching between base paths
    internal static let originalBasePath = "http://petstore.swagger.io/v2"
    ...
    */
    ...
    /**
        Revert back to the original base path of the Swagger_Petstore_ServerSDK's API
    */
...
public extension Swagger_Petstore_ServerSDKUtility {
