...
let package = Package(
    ...
    targets: [
      .target(name: "logia", dependencies: [ .target(name: "Application"), "Kitura" , "HeliumLogger"]),
      .target(name: "Application", dependencies: [ "Kitura", "CloudEnvironment","SwiftMetrics","Health",.target(name: "Generated"),
.target(name: "Swagger_Petstore_ServerSDK"),
      ]),
      .target(name: "Swagger_Petstore_ServerSDK", dependencies: ["SimpleHttpClient"], path: "Sources/Swagger_Petstore_ServerSDK" ),
